...
*/
param aiFoundryName string = 'RedTeaming-new-Foundry' // change this to your Azure AI Foundry name
param location string = 'swedencentral' // change this to your preferred Azure region

param connectedResourceName string = 'redteamingstorage2'
