...
async def main():
    ...
    endpoint = os.environ.get("AZURE_PJ_MODEL_ENDPOINT")
    deployment = os.environ.get("AZURE_PJ_MODEL_NAME")
    api_key = os.environ.get("AZURE_PJ_MODEL_API_KEY")
    
    # Get Azure AI Project details from environment variables
    ai_project_endpoint = os.environ.get("AZURE_PJ_PROJECT_ENDPOINT")
